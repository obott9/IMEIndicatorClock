=====================================
IMEIndicatorClock - README
=====================================

[About]
A macOS utility that displays Input Method Editor (IME) status
near the mouse cursor and on an analog clock.
...
[Installation]
1. Drag IMEIndicatorClock.app to your Applications folder
2. Launch the app
